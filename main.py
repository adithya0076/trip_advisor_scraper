...
from sources.trip_advisor_rentals_scraper import TripAdvisorRentalsScraper
...
obj1.check_connection()
driver = obj1.getdriver()
rental = TripAdvisorRentalsScraper(obj1, db)
rental.search_for_rentals(driver=driver, city="Sri Lanka")
time.sleep(10)
# url = rental.traverse_through_cities(driver=driver)
# rental.traverse_through_cities_pagination(driver=driver, current_url='https://www.tripadvisor.com/rentals-g293961-Sri_Lanka.html#LOCATION_LIST')
condition = 'type_id="%s" ' % 4
data = db.select_rows("url_log", condition)
print(data)
if data.empty is True:
    print("No Data")
    ...
    time.sleep(5)
    rental.scraping_rental_information(driver, data)
obj1.check_connection()
driver.get("https://www.tripadvisor.com")
